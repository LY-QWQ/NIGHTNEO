package com.opennight.utils.rotation;

import com.opennight.NightNeo;
import net.minecraft.network.protocol.game.ServerboundChatPacket;
import net.minecraft.network.protocol.game.ServerboundMovePlayerPacket;
import com.opennight.ClientBase;
import com.opennight.event.impl.CameraPitchEvent;
import com.opennight.event.impl.ChatEvent;
import com.opennight.event.impl.FallFlyingEvent;
import com.opennight.event.impl.RotationAnimationEvent;
import com.opennight.event.impl.JumpMarkerEvent;
import com.opennight.event.impl.MotionEvent;
import com.opennight.event.impl.PacketEvent;
import com.opennight.event.impl.RayTraceEvent;
...
import com.opennight.event.impl.UseItemRayTraceEvent;
import com.opennight.event.impl.WorldChangeEvent;
...
import com.opennight.utils.animation.TickTimer;
...
public class RotationHandler
    ...
    public void onMotion(MotionEvent e) {
        if (e.isPost()) {
            if (mc.player != null && mc.player.tickCount <= 1 && NightNeo.isReady()) {
                NightNeo.instance.getEventBus().call(new WorldChangeEvent());
            }
            if (mc.player == null) {
                return;
            }
