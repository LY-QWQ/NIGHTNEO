...
// REMOVED: import net.minecraft.network.protocol.game.ClientboundDisconnectPacket;
...
// REMOVED: import net.minecraft.network.protocol.login.ClientboundGameProfilePacket;
// REMOVED: import net.minecraft.network.protocol.status.ClientboundPongResponsePacket;
import com.opennight.ClientBase;
import com.opennight.NightNeo;
import com.opennight.event.impl.PacketSendEvent;
...
extends ClientBase {
    ...
    public static boolean shouldBypass(Packet<ServerGamePacketListener> packet) {
        ...
        NightNeo.instance.getEventBus().call(packetSendEvent);
