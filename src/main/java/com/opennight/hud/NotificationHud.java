...
import com.opennight.utils.misc.SoundUtil;
...
public class NotificationHud extends HudElement {
    ...
    public void onModuleToggle(ModuleToggleEvent event) {
        ...
        if (this.isEnabled() && needSound.getValue()) {
            if ("Lever".equals(whichSound.getValue())) {
                ...
                String soundPath = event.enabled() ? "/assets/opennight/notifications/Enabled.wav" : "/assets/opennight/notifications/Disabled.wav";
    ...
    private void loadTextures() {
        ...
        enabledIcon = TextureUtil.loadResourceTexture("/assets/opennight/notifications/Enabled.png");
        disabledIcon = TextureUtil.loadResourceTexture("/assets/opennight/notifications/Disabled.png");
    }
