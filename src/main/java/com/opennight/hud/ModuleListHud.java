...
import com.opennight.utils.render.GradientTheme;
...
public class ModuleListHud extends HudElement {
    ...
    private List<AnimatedRow> updateRows() {
        ...
        for (Module module : NightNeo.instance.getModuleManager().getModules()) {
    ...
    private boolean shouldRender() {
        ...
        Interface interfaceModule = NightNeo.instance.getModuleManager().getModule(Interface.class);
