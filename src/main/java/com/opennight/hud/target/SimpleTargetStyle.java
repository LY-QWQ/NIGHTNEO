package com.opennight.hud.target;
...
import com.opennight.modules.impl.render.NameProtect;
...
import com.opennight.render.Renderer;
import com.opennight.utils.animation.SmoothAnimationTimer;
import com.opennight.utils.math.Easings;
import com.opennight.utils.render.RenderUtil;

public class SimpleTargetStyle
        extends TargetStyle {
    ...
    public void render(Render2DEvent render2DEvent, LivingEntity livingEntity, SmoothAnimationTimer healthAnim, SmoothAnimationTimer healthLagAnim, float healthPct, float x, float y) {
        ...
        Renderer.renderConsumer((drawContext -> {
            ...
            String displayerHealth = "HP: " + (int) Math.ceil(target.getHealth());
            ...
            GlHelper.drawTextShadowLegacy(displayerHealth,contentX,nameY + 14.0f + slideOff, this.subFont, new Color(1.0f, 1.0f, 1.0f, Math.min(fade,80.0f)).getRGB());

            float healthY = belowNameY + 17.0f;
            float healthH = 3.0f;
            ...
            this.healthLagPaint.setColor(new Color(191, 64, 78, (int)((float)COLOR_HEALTH_LAG.getAlpha() * fade)).getRGB());
    ...
    static {
        currentTargetName = "Simple";
        COLOR_PANEL_BG = new Color(0, 0, 0, 70);
        COLOR_HEALTH_BG = new Color(0, 0, 0, 90);
        COLOR_HEALTH_BAR = new Color(255, 255, 255);
        COLOR_HEALTH_BAR2 = new Color(255, 255, 255);
        COLOR_HEALTH_LAG = new Color(150, 30, 30, 120);
    }
}
// Edit by p ick bo w en