...
import com.opennight.event.impl.RenderEntityEvent;
import com.opennight.event.impl.RotationAnimationEvent;
import com.opennight.modules.impl.render.FakeAntiAim;
...
public class LivingEntityRendererPatch {
    ...
    public static void onRenderPost(
        ...
        NightNeo.instance.getEventBus().call(post);
    }
