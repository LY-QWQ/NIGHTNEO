...
import com.opennight.event.impl.ChatReceiveEvent;
import com.opennight.hud.TabListInfo;
import com.opennight.modules.impl.render.Watermark;
...
public class PlayerTabOverlayPatch extends ClientBase {
    ...
    public static void onRenderPre(PlayerTabOverlay overlay, GuiGraphics graphics, int width, Scoreboard scoreboard, Objective objective, CallbackInfo callbackInfo) {
        ...
        if (!NightNeo.isReady() || NightNeo.instance.getModuleManager() == null) return;
        Watermark watermark = (Watermark) NightNeo.instance.getModuleManager().getModule(Watermark.class);
