...
import com.opennight.event.impl.PrePacketEvent;
...
public class ConnectionPatch extends ClientBase {
    public static boolean onPacketReceive(Packet<?> packet) {
        if (mc == null || mc.level == null || mc.player == null || packet == null || !NightNeo.isReady()) {
            return false;
        }
        PrePacketEvent prePacket = new PrePacketEvent(packet);
        NightNeo.instance.getEventBus().call(prePacket);
        ...
        NightNeo.instance.getEventBus().call(receiveEvent);
