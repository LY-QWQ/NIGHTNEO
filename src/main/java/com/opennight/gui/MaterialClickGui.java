...
import com.opennight.gui.material3.MD3Theme;
import com.opennight.gui.material3.setting.MD3SettingRegistry;
import com.opennight.gui.panel.setting.NumberSettingRenderer;
...
public class MaterialClickGui extends Screen {
    ...
    private int categoryCount(Category category) {
        return NightNeo.instance.getModuleManager() != null
                ? (int) NightNeo.instance.getModuleManager().getModules().stream()
    ...
    private void syncTheme() {
        try {
            ClickGuiModule clickGui = NightNeo.instance.getModuleManager().getModule(ClickGuiModule.class);
    ...
    private void doSearch() {
        ...
        modules = NightNeo.instance.getModuleManager().getModules().stream()
    ...
    private void tickState() {
        switch (state) {
            ...
            case CLOSING -> {
                ...
                if (openT <= 0f) {
                    state = State.CLOSED;
                    if (NightNeo.isReady()) NightNeo.instance.getConfigManager().saveAll();
