...
import com.opennight.gui.newclickgui.ModuleElement;
...
import com.opennight.render.StencilHelper;
...
extends UIElement {
    ...
    public CategoryPanel(Category category) {
        ...
        for (Module module : NightNeo.getInstance().getModuleManager().getModulesByCategory(category)) {
