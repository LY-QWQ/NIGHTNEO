...
import com.opennight.modules.impl.misc.music.LyricLine;
import com.opennight.modules.impl.misc.music.MusicHttp;
import com.opennight.modules.impl.misc.music.NeteaseApi;
import com.opennight.modules.impl.misc.music.SongInfo;
import com.opennight.modules.impl.render.LyricsModule;
...
public class MusicPlayerScreen extends Screen {
    ...
    private void playSong(SongInfo song, List<SongInfo> queue, int index, boolean autoAdvance) {
        ...
        NeteaseApi.getLyrics(song.id).thenAccept(lines -> {
            ...
            try {
                LyricsModule module = NightNeo.instance.getModuleManager().getModule(LyricsModule.class);
                if (module != null) {
    ...
    private void updateVolume(double mouseX) {
        ...
        MusicPlayer module = NightNeo.instance.getModuleManager().getModule(MusicPlayer.class);
        if (module != null) {
