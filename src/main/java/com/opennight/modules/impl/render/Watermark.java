...
import com.opennight.hud.DynamicIsland;
import com.opennight.hud.LogoWatermark;
import com.opennight.hud.NeverloseWatermark;
...
public class Watermark extends Module {
    ...
    private void renderSimple(DrawContext ctx) {
        ...
        String icon = "N";
        String clientName = NightNeo.CLIENT_NAME;
    ...
    private void renderPharos(DrawContext ctx) {
        ...
        ctx.drawString(NightNeo.CLIENT_NAME, titleX, titleY, titleFont, textPaint);
